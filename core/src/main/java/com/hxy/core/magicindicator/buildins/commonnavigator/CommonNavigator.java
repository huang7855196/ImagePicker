package com.hxy.core.magicindicator.buildins.commonnavigator;
...
import com.hxy.core.magicindicator.NavigatorHelper;
import com.hxy.core.magicindicator.ObservableHorizontalScrollView;
import com.hxy.core.magicindicator.ScrollState;
import com.hxy.core.magicindicator.abs.IPagerNavigator;
import com.hxy.core.magicindicator.buildins.commonnavigator.abs.CommonNavigatorAdapter;
import com.hxy.core.magicindicator.buildins.commonnavigator.abs.IMeasurablePagerTitleView;
...
import com.hxy.core.magicindicator.buildins.commonnavigator.model.PositionData;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    /**
     * Instantiates a new Common navigator.
     *
    ...
    private void init() {
        ...
        mScrollView = (ObservableHorizontalScrollView) root.findViewById(R.id.scroll_view);   // mAdjustMode为true时，mScrollView为null
        ...
        for (int i = 0, j = mNavigatorHelper.getTotalCount(); i < j; i++) {
            ...
            if (v instanceof View) {
                ...
                if (mAdjustMode) {
                    ...
                    lp.setMargins(mLeftMargin,0,mLeftMargin,0);
    ...
    public void onEnter(int index, int totalCount, float enterPercent, boolean leftToRight) {
        ...
        if (v instanceof IPagerTitleView) {
            ...
            if (mLeftMargin!=0) {
                ...
                layoutParams.setMargins((int) (mLeftMargin * enterPercent), 0, (int) (mLeftMargin * enterPercent), 0);
    ...
    public void onLeave(int index, int totalCount, float leavePercent, boolean leftToRight) {
        ...
        if (v instanceof IPagerTitleView) {
            ...
            if (mLeftMargin!=0) {
                LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) v.getLayoutParams();
                layoutParams.setMargins(mLeftMargin - (int) (mLeftMargin * leavePercent), 0, mLeftMargin - (int) (mLeftMargin * leavePercent), 0);
                v.setLayoutParams(layoutParams);
            }
        }
    }
